./easySFS.py -i all/filtered_mincov.recode.vcf -p all/pop.txt --preview -a

./easySFS.py -i all/filtered_mincov.recode.vcf -p all/pop.txt --a --proj=20,16 -o all/output
